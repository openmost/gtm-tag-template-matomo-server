...

{
  ...
  "description": "Send server-side hits to Matomo: lossless replay of hits from the Matomo Client (FormAnalytics, MediaAnalytics, A/B testing…) or automatic mapping of GA4 events (pageviews, events, site search, ecommerce, goals, custom dimensions), with cookie-consent handling.",
  "containerContexts": [
    "SERVER"
  ]
}
...
[
  ...
  },
  {
    ...
    "simpleValueType": true,
    "help": "Base URL of your Matomo instance, e.g. https://analytics.example.com",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      },
  ...
  },
  {
    "type": "TEXT",
    "name": "tokenAuth",
    "displayName": "Auth token (token_auth)",
    "simpleValueType": true,
    "help": "Token of a user with at least write access to the site. Required to send the real visitor IP (cip). Sent in the POST body only.",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
    ...
    "subParams": [
      {
        "type": "SELECT",
        "name": "consentSource",
        "displayName": "Analytics consent source",
        "macrosInSelect": false,
        "selectItems": [
          {
            "value": "auto",
            "displayValue": "Automatic (GA4 consent mode for GA4 events, matomo.js for Matomo Client events)"
          },
          {
            "value": "variable",
      ...
      },
      {
        "type": "TEXT",
        "name": "consentValue",
        "displayName": "Consent value (granted / denied, true / false)",
        "simpleValueType": true,
        "enablingConditions": [
          {
      ...
      {
        "type": "CHECKBOX",
        "name": "stripUidOnDenied",
        "checkboxText": "Also remove the User ID when consent is denied",
        "simpleValueType": true,
        "defaultValue": true
      }
    ]
  },
  {
    "type": "GROUP",
    "name": "ga4Group",
    "displayName": "GA4 events mapping",
    ...
    "subParams": [
      ...
      },
      {
        ...
        "simpleTableColumns": [
          ...
          {
            "defaultValue": "",
            "displayName": "Matomo dimension ID",
            "name": "dimensionId",
            "type": "TEXT"
          }
        ]
      },
      {
        "type": "TEXT",
        "name": "cartItems",
        "displayName": "Full cart content (variable returning GA4 items)",
        "simpleValueType": true,
        "help": "Matomo needs the whole cart on every cart update. When set, add_to_cart / remove_from_cart / view_cart also send a Matomo cart update."
      },
      {
        "type": "CHECKBOX",
        "name": "sendProductViews",
    ...
    "subParams": [
      {
        "type": "SIMPLE_TABLE",
        "name": "overrides",
        "displayName": "Set or override Matomo parameters",
        "simpleTableColumns": [
          {
            "defaultValue": "",
      ...
      },
      {
        "type": "TEXT",
        "name": "removeParams",
        "displayName": "Remove Matomo parameters (comma-separated)",
        "simpleValueType": true
      }
    ]
  }
...
- name: token auth never appears in the URL
  code: |-
...
- name: array parameters are sent as repeated keys and UTF8 is encoded
  code: |-
...
- name: GA4 event without site ID fails without sending
  code: |-
    ...
    assertApi('gtmOnFailure').wasCalled();
- name: GA4 page view maps to a Matomo pageview with hashed visitor id
  code: |-
...
- name: event category and event action parameters override automatic values
  code: |-
...
- name: numeric value becomes event value and non numeric is dropped
  code: |-
...
- name: GA4 consent denied strips identifiers while granted or absent keeps them
  code: |-
...
Built from src/ with tools/gtm-tpl.
